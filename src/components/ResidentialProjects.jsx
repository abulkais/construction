            ...
            <section className='projects_section2'>
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://www.bricknbolt.com/assets/images/temp/img_1_beforerender@3x.webp" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3.ap-south-1.amazonaws.com/CRN559_A1.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://s3.ap-south-1.amazonaws.com/bnb-pluck.appspot.com/project/documents/rc-upload-1631937676289-151.JPG" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3-ap-south-1.amazonaws.com/project/documents/3GMztPPopw142uPqv3wngY.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3-ap-south-1.amazonaws.com/test/kSmnUS3tY42dheGZEz4M33.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3-ap-south-1.amazonaws.com/project/documents/mMBy62N8vbru6n9VtE7ApN.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3-ap-south-1.amazonaws.com/project/documents/aVy71ozB96neY3gREpnbnF.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
                        ...
                        <div className="col-lg-4">
                            <div className="card">
                                <img className='card-img-top' src="https://website-data-pluckwalk.s3-ap-south-1.amazonaws.com/project/documents/hZoCLPvuXwYA7Er4XFKpNC.jpeg" alt="" />
                                <div className="card-footer">
                                    <p>CRN1925</p>
                                    <p>Nelamangala Town, Bengaluru</p>
                                    <div className="classic">
